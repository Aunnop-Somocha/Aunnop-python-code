...
print("- Total chracters: %d (with spaces), %d (without spaces)" % (len(string), len(string)-string.count(" ")))
strLower = string.lower()
vowels = strLower.count("a") + strLower.count("e") +  strLower.count("i") + strLower.count("o") 
+ strLower.count("u")
vowelsStr = " "
